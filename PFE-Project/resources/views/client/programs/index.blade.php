    ...
    @if($programData['program_title'] !== 'NO_ACTIVE_PROTOCOL')
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-16">
                <div class="flex-1">
                    ...
                    <h1 class="text-3xl sm:text-5xl md:text-6xl font-mono font-bold tracking-tighter uppercase text-zinc-900 leading-none">Active Protocol</h1>
                ...
                <div class="mt-8 lg:mt-0 flex space-x-4">
                    <div class="ag-card px-4 sm:px-8 py-5 bg-white flex flex-col items-center justify-center border border-zinc-100 shadow-sm">
