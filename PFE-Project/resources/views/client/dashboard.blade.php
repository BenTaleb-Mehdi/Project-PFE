...
<div x-data="{ 
    ...
    <div class="space-y-12">
        <header class="mb-12">
            ...
            <p class="text-[10px] font-mono text-zinc-400 mt-2 uppercase tracking-[0.2em]">Pupil_Intel // Progress_Sync_Active</p>
        </header>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            <div class="ag-card p-8 bg-white overflow-hidden relative">
                <p class="text-[10px] font-mono text-zinc-400 uppercase tracking-widest mb-4">Morning_Weight</p>
            ...
            <div class="ag-card p-8 bg-white">
                <p class="text-[10px] font-mono text-zinc-400 uppercase tracking-widest mb-4">Weekly_Compliance</p>
                <div class="flex items-baseline space-x-2">
            ...
            <div class="ag-card p-8 bg-white border-emerald-100/50">
                <p class="text-[10px] font-mono text-zinc-400 uppercase tracking-widest mb-4">Streak_Status</p>
                <div class="flex items-baseline space-x-2">
                    <span class="text-3xl font-mono font-bold text-emerald-600">14_Days</span>
                </div>
                <p class="text-[8px] font-mono text-zinc-400 mt-4 uppercase tracking-[0.2em]">Unbroken_Record</p>
            </div>
        </div>

        <!-- Weight Update Pulse -->
        <div class="ag-card p-8 bg-white">
            <h3 class="text-xs font-mono font-bold uppercase tracking-widest mb-6 border-b border-zinc-100 pb-4">Weight_Update_Pulse</h3>
            <form action="{{ route('client.evolution.store') }}" method="POST" class="flex flex-col md:flex-row md:items-end space-y-4 md:space-y-0 md:space-x-4">
                @csrf
                <div class="flex-1">
                    <label class="block text-[8px] font-mono text-zinc-400 uppercase tracking-widest mb-2">New_Measurement (KG)</label>
        ...
        <div class="ag-card p-8 bg-cyan-900 border-none text-white overflow-hidden relative">
            <div class="relative z-10 flex flex-col md:flex-row justify-between md:items-end">
                <div>
                    <p class="text-[10px] font-mono text-cyan-300 uppercase tracking-[0.3em] mb-4">Active_Protocol_Lock</p>
                    <h4 class="text-3xl font-bold font-mono tracking-tight uppercase">{{ $programData['program_title'] }}</h4>
                    <p class="text-[8px] text-cyan-500 font-mono mt-2 uppercase tracking-widest">{{ $programData['items_count'] }} Meal_Nodes // Sync_Active</p>
                </div>
                <div class="mt-8 md:mt-0 flex gap-4">
                    <div class="p-4 bg-white/5 ag-border border-white/10 text-center flex-1 md:flex-none">
                        <p class="text-[6px] text-cyan-400 uppercase font-mono mb-1">Target_Kcal</p> 
                    ...
                    <div class="p-4 bg-white/5 ag-border border-white/10 text-center flex-1 md:flex-none text-emerald-400">
                        <p class="text-[6px] text-cyan-400 uppercase font-mono mb-1">Target_P</p> 
        ...
        <div class="p-12 text-center ag-card bg-zinc-50 border-dashed border-zinc-200">
            ...
            <p class="text-[10px] text-zinc-500 uppercase font-mono tracking-widest">No_Active_Protocol_Found</p>
        </div>
        @endif
    </div>
</div>
