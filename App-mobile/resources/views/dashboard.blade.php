...
>
    ...
    <nav class="absolute bottom-0 left-0 right-0 bg-white border-t border-zinc-200 z-40 shrink-0">
        <div class="flex justify-around items-center h-16 px-2">
            <a href="#" class="flex flex-col items-center justify-center w-full h-full text-cyan-700 relative">
                <div class="absolute top-0 left-1/2 -translate-x-1/2 w-8 h-0.5 bg-cyan-600"></div>
            ...
            <a href="#" class="flex flex-col items-center justify-center w-full h-full text-zinc-400 hover:text-zinc-900 transition-colors">
                <i data-lucide="utensils" class="h-5 w-5 mb-1"></i>
