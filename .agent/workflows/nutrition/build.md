---
description: Nutrition Hierarchy & Logic Build
---

# 🥗 NUTRITION ENGINE WORKFLOW

## Phase 1: Category Mapping
- Define meal sequences in `categories.html`.
...
- Support `Draft_Mode` with dashed borders and high-contrast badges.
